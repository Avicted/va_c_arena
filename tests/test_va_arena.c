...
int
test_arena_used_and_total_size(void)
{
	Arena *arena = arena_create(1024);
	if (!arena)
	{
...
int
test_arena_alloc_aligned_invalid_alignment(void)
{
	Arena *arena = arena_create(1024);
	if (!arena)
	{
